...
<style>
  ...
  html, body {
    ...
    font-size: 13.5px; /* Sedikit diperkecil dari default */
  ...
  .main {
    ...
    display: flex;
    flex-direction: column;
    min-width: 0; /* Important for flex children to allow text truncation/shrinking */
    background-color: var(--bg-light);
    height: 100vh;
    overflow-y: auto;
  ...
  .stat-icon {
    ...
    height: 45px;
    border-radius: 10px;
    background: rgba(188, 0, 7, 0.08); /* Light Red */
    color: var(--primary);
    display: flex;
    align-items: center;
    justify-content: center;
  ...
  .stat-info {
    flex: 1;
    min-width: 0; /* Ensures child text can truncate/wrap */
  }
  .stat-label {
    font-size: 0.8rem;
  ...
  .stat-value {
    ...
    font-weight: 800;
    color: #111;
    word-break: break-word; /* Allows breaking lines if the amount gets too big */
    line-height: 1.2;
  }
...
<div class="wrapper">
  ...
  <nav id="sidebar" class="sidebar">
    <a class="sidebar-header-brand" href="{{ route('admin.home') }}">
      <img src="{{ asset('admin_asset/img/photos/logo_telkomsel.png') }}" onerror="this.src='https://upload.wikimedia.org/wikipedia/commons/b/bc/Telkomsel_2021_icon.svg'" alt="Telkomsel" />
      <div>
    ...
    <nav class="top-navbar">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 mt-2">
          <li><a class="dropdown-item py-2" href="#"><i class="fas fa-user me-2 text-muted"></i> Profil</a></li>
